...
Dozer makes it easy to build low-latency data APIs (gRPC and REST) from any data source. Data is transformed on the fly using Dozer's reactive SQL engine  and stored in a high-performance always up-to-date cache to offer the best possible experience. Dozer is useful for quickly building data products.
